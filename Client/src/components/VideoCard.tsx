        ...
        <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 flex justify-center gap-4 p-4">
                <button
                    ...
                    className={`p-2 rounded-full shadow-md transition-transform transform hover:scale-110 ${camEnabled ? "bg-red-500" : "bg-green-500"
                        }`}
                >
                    {camEnabled ? (
                        <svg
                ...
                <button
                    ...
                    className={`p-2 rounded-full shadow-md transition-transform transform hover:scale-110 ${micEnabled ? "bg-red-500" : "bg-green-500"
                        }`}
                >
                    {micEnabled ? (
                        <svg
